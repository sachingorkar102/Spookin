...
public class ConfigUpdater {
    ...
    public static void updateWithoutComments(Spookin plugin,String fileName,File toUpdate){
     ...
     */
    public static void update(Spookin plugin, String resourceName, File toUpdate, List<String> ignoredSections,boolean unregister) throws IOException {
    ...
    private static void write(FileConfiguration newConfig, FileConfiguration oldConfig, Map<String, String> comments, List<String> ignoredSections, BufferedWriter writer, Yaml yaml,Spookin plugin,boolean unregister) throws IOException {
